/*
  ...
  1. Vista: lost_sales_report
    - Agrupa items de diagnóstico por categoría e item
    - Calcula estadísticas de autorización/rechazo
    - Muestra ingresos perdidos vs capturados
    - Tasa de rechazo por servicio
